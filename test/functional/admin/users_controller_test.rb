...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { admin: @admin_user.admin, email: @admin_user.email, forename: @admin_user.forename, surname: @admin_user.surname, title: @admin_user.title }
    end
  ...
  test "should update admin_user" do
    put :update, id: @admin_user, admin_user: { admin: @admin_user.admin, email: @admin_user.email, forename: @admin_user.forename, surname: @admin_user.surname, title: @admin_user.title }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
